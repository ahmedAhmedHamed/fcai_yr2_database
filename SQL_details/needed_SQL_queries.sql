...
SELECT f.flight_id, f.flight_date, f.sourcee, f.destination, a.aircraft_name, a.total_seats
FROM flights f
INNER JOIN aircraft a
ON f.aircraft_id = a.aircraft_id
WHERE f.flight_date = '2023-06-01'
AND f.sourcee = 'cairo'
AND f.destination = 'usa'
AND a.total_seats >= 2;

-- Booking a flight
INSERT INTO booking (booking_id, user_id, flight_id, class_type, seats_booked)
VALUES (1, 1, 1, 'business', 2);
